...
folder_path = "/Path/To/Frames" # outputted by capture_video.py
        ...
        for point in contour:
            ...
            if abs(dist_to_center - circle_radius) < 10: # find objects on/near the circle's circumference
                ...
                if object_size > min_object_size:
                    ...
                    if not is_duplicate: # counter annoying pulsing noise when large objects remain on the circumference
